...
/**
 * Grille de projets façon lusion.co/projects. Reçoit les projets en props
 * (chargés côté serveur depuis Firestore). Au clic : la carte s'agrandit en
 * plein écran (« on entre dans le projet ») puis la navigation se fait.
 */
