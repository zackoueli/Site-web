...
export default function About() {
  return (
    <section id="a-propos" className="py-24 bg-[#0A0A0A] text-[#FFFBF0]">
      <div className="max-w-6xl mx-auto px-4">

        {/* Header */}
        <div className="mb-16">
          <p className="mono text-sm font-bold mb-2 text-gray-500">// qui je suis</p>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          {/* Bio */}
          <div>
            <div className="brutal-border brutal-shadow bg-[#FFE234] text-[#0A0A0A] p-8 mb-6">
            ...
            <div className="brutal-border bg-[#1a1a1a] p-6 space-y-3">
              <div className="flex items-center gap-3">
                <span className="mono text-xs text-gray-500 w-24 shrink-0">Stack</span>
                <span className="font-bold text-sm">React Native · Next.js · Firebase · Stripe</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="mono text-xs text-gray-500 w-24 shrink-0">Spécialité</span>
                <span className="font-bold text-sm">Apps mobiles & plateformes métier</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="mono text-xs text-gray-500 w-24 shrink-0">Localisation</span>
                <span className="font-bold text-sm">Brest, Bretagne 🏴󠁧󠁢󠁷󠁬󠁳󠁿</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="mono text-xs text-gray-500 w-24 shrink-0">Disponibilité</span>
          ...
          <div className="grid sm:grid-cols-2 gap-4 content-start">
            {values.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="brutal-border bg-[#141414] p-5">
                <Icon size={20} className="text-[#FFE234] mb-3" />
        ...
        <div className="flex flex-wrap gap-4 items-center">
          <a
            href="#contact"
            className="brutal-btn bg-[#FF6B9D] text-white px-8 py-4 text-base"
          >
            Démarrer mon projet
          </a>
          <a
