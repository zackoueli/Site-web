      ...
      <div className="max-w-6xl mx-auto px-4 py-10 grid sm:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 brutal-border brutal-shadow bg-[#FF6B9D] text-white px-4 py-2 text-sm font-bold hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_#000] transition-all"
          >
