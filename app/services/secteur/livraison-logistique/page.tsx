...
export const metadata: Metadata = {
  ...
  description:
    "Créez votre app de livraison sur mesure : suivi en temps réel, gestion des livreurs, paiement Stripe, zones de livraison. Sans commission Uber Eats.",
  ...
  return (
    <>
      ...
      <main className="bg-[#FFFBF0] min-h-screen">
        ...
        <section className="border-b-[3px] border-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              ...
              <Link href="/blog/combien-coute-application-mobile" className="brutal-btn bg-[#FF6B35] text-white px-8 py-4">En savoir plus →</Link>
            </div>
        ...
        <RelatedArticles service="livraison-logistique" />
